...
static const uint16_t heart_rate_svc = ESP_GATT_UUID_DEVICE_INFO_SVC;
...
static const uint16_t body_sensor_location_uuid = ESP_GATT_UUID_TX_POWER_LEVEL;
static const uint8_t body_sensor_loc_val[4] = { (uint8_t) 0,  (uint8_t) 0, (uint8_t) 0, (uint8_t) 0 };


/// Heart Rate Sensor Service - Heart Rate Control Point characteristic, write&read
static const uint16_t heart_rate_ctrl_point = ESP_GATT_UUID_BATTERY_LEVEL;
...
static const esp_gatts_attr_db_t heart_rate_gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&body_sensor_location_uuid, ESP_GATT_PERM_WRITE|ESP_GATT_PERM_READ,
      sizeof(u_int32_t), sizeof(body_sensor_loc_val), (uint8_t *)body_sensor_loc_val}},
